...
void ser_members(cryptonote::COMMAND_REQUEST_STAT_INFO::request &v, seria::ISeria &s);
void ser_members(cryptonote::COMMAND_REQUEST_STAT_INFO::response &v, seria::ISeria &s);
void ser_members(cryptonote::COMMAND_REQUEST_NETWORK_STATE::request &v, seria::ISeria &s);
