...
static const char USAGE[] =
    R"(walletd )" cryptonote_VERSION_STRING R"(.
...
Options:
  ...
  --cryptonoted-authorization=<usr:pass> HTTP authorization for RCP.
...
int main(int argc, const char *argv[]) try {
	...
	logManagerNode.configure_default(config.get_data_folder("logs"), "cryptonoted-");
