...
std::unordered_map<std::string, Node::JSONRPCHandlerFunction> Node::m_jsonrpc_handlers = {
    {api::cryptonoted::GetBlockTemplate::method(), json_rpc::makeMemberMethodSeria(&Node::on_getblocktemplate)},
    {api::cryptonoted::GetBlockTemplate::method_legacy(), json_rpc::makeMemberMethodSeria(&Node::on_getblocktemplate)},
    {api::cryptonoted::GetCurrencyId::method(), json_rpc::makeMemberMethodSeria(&Node::on_get_currency_id)},
    {api::cryptonoted::GetCurrencyId::method_legacy(), json_rpc::makeMemberMethodSeria(&Node::on_get_currency_id)},
    {api::cryptonoted::SubmitBlock::method(), json_rpc::makeMemberMethodSeria(&Node::on_submitblock)},
    {api::cryptonoted::SubmitBlockLegacy::method(), json_rpc::makeMemberMethodSeria(&Node::on_submitblock_legacy)},
    {api::cryptonoted::GetRandomOutputs::method(), json_rpc::makeMemberMethodSeria(&Node::on_get_random_outputs3)},
    {api::cryptonoted::GetStatus::method(), json_rpc::makeMemberMethodSeria(&Node::on_get_status3)},
    {api::cryptonoted::GetStatus::method2(), json_rpc::makeMemberMethodSeria(&Node::on_get_status3)},
    {api::cryptonoted::SendTransaction::method(), json_rpc::makeMemberMethodSeria(&Node::handle_send_transaction3)},
    {api::cryptonoted::CheckSendProof::method(), json_rpc::makeMemberMethodSeria(&Node::handle_check_send_proof3)},
    {api::cryptonoted::SyncBlocks::method(), json_rpc::makeMemberMethodSeria(&Node::on_wallet_sync3)},
    {api::cryptonoted::SyncMemPool::method(), json_rpc::makeMemberMethodSeria(&Node::on_sync_mempool3)}};
