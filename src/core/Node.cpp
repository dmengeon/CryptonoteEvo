...
const std::unordered_map<std::string, Node::HTTPHandlerFunction> Node::m_http_handlers = {
    ...
    {api::cryptonoted::SyncBlocks::binMethod(), binMethod2(&Node::on_wallet_sync3)},
    {api::cryptonoted::SyncMemPool::binMethod(), binMethod2(&Node::on_sync_mempool3)},
...
const std::unordered_map<std::string, Node::JSONRPCHandlerFunction> Node::m_jsonrpc_handlers = {
    {api::cryptonoted::GetLastBlockHeaderLegacy::method(), json_rpc::makeMemberMethod(&Node::on_get_last_block_header)},
    ...
    {api::cryptonoted::GetBlockTemplate::method(), json_rpc::makeMemberMethod(&Node::on_getblocktemplate)},
    {api::cryptonoted::GetBlockTemplate::method_legacy(), json_rpc::makeMemberMethod(&Node::on_getblocktemplate)},
    {api::cryptonoted::GetCurrencyId::method(), json_rpc::makeMemberMethod(&Node::on_get_currency_id)},
    {api::cryptonoted::GetCurrencyId::method_legacy(), json_rpc::makeMemberMethod(&Node::on_get_currency_id)},
    {api::cryptonoted::SubmitBlock::method(), json_rpc::makeMemberMethod(&Node::on_submitblock)},
    {api::cryptonoted::SubmitBlockLegacy::method(), json_rpc::makeMemberMethod(&Node::on_submitblock_legacy)},
    {api::cryptonoted::GetRandomOutputs::method(), json_rpc::makeMemberMethod(&Node::on_get_random_outputs3)},
    {api::cryptonoted::GetStatus::method(), json_rpc::makeMemberMethod(&Node::on_get_status3)},
    {api::cryptonoted::GetStatus::method2(), json_rpc::makeMemberMethod(&Node::on_get_status3)},
    {api::cryptonoted::SendTransaction::method(), json_rpc::makeMemberMethod(&Node::handle_send_transaction3)},
    {api::cryptonoted::CheckSendProof::method(), json_rpc::makeMemberMethod(&Node::handle_check_send_proof3)},
    {api::cryptonoted::SyncBlocks::method(), json_rpc::makeMemberMethod(&Node::on_wallet_sync3)},
    {api::cryptonoted::SyncMemPool::method(), json_rpc::makeMemberMethod(&Node::on_sync_mempool3)}};
