...
void cryptonote::decompose_amount(Amount amount, Amount dustThreshold, std::vector<Amount> &decomposedAmounts) {
...
size_t cryptonote::get_maximum_tx_size(size_t inputCount, size_t outputCount, size_t mixinCount) {
