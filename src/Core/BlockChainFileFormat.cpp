...
bool LegacyBlockChainReader::import_blockchain2(const std::string &coin_folder, BlockChainState &block_chain) {
	//	std::fstream ts_file("/Users/user/cryptonote/timestamps.txt",
...
void LegacyBlockChainWriter::write_block(const cryptonote::RawBlock &raw_block) {
	cryptonote::BinaryArray ba = seria::to_binary(raw_block);
