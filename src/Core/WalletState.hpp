...
class WalletPreparatorMulticore {
	...
	api::cryptonoted::SyncBlocks::Response work;
	int work_counter = 0;
...
public:
	...
	~WalletPreparatorMulticore();
	void cancel_work();
	void start_work(const api::cryptonoted::SyncBlocks::Response &new_work, const SecretKey &view_secret_key);
...
public:
	...
	bool sync_with_blockchain(const api::cryptonoted::SyncMemPool::Response &);
