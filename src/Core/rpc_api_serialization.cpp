...
void ser_members(api::cryptonoted::GetStatus::Request &v, ISeria &s) {
...
void ser_members(api::cryptonoted::GetStatus::Response &v, ISeria &s) {
	ser_members(static_cast<api::cryptonoted::GetStatus::Request &>(v), s);
...
void ser_members(api::cryptonoted::SyncBlocks::Request &v, ISeria &s) {
...
void ser_members(api::cryptonoted::SyncBlocks::Response &v, ISeria &s) {
	seria_kv("blocks", v.blocks, s);
	seria_kv("start_height", v.start_height, s);
	seria_kv("status", v.status, s);
}
void ser_members(api::cryptonoted::SyncMemPool::Request &v, ISeria &s) {
	if (!s.is_input())
...
void ser_members(api::cryptonoted::GetRandomOutputs::Request &v, ISeria &s) {
	seria_kv("amounts", v.amounts, s);
	seria_kv("outs_count", v.outs_count, s);
	seria_kv("confirmed_height_or_depth", v.confirmed_height_or_depth, s);
}
void ser_members(api::cryptonoted::GetRandomOutputs::Response &v, ISeria &s) { seria_kv("outputs", v.outputs, s); }
void ser_members(api::cryptonoted::SendTransaction::Request &v, ISeria &s) {
	seria_kv("binary_transaction", v.binary_transaction, s);
}
void ser_members(api::cryptonoted::SendTransaction::Response &v, ISeria &s) { seria_kv("send_result", v.send_result, s); }
...
/*void ser_members(cryptonote::api::walletd::GetBlock::Request &v, ISeria &s) {
        seria_kv("hash", v.hash, s);
        seria_kv("height", v.height, s);
}*/
void ser_members(cryptonote::api::walletd::GetTransaction::Request &v, ISeria &s) { seria_kv("hash", v.hash, s); }
...
void ser_members(cryptonote::api::cryptonoted::SubmitBlock::Response &v, ISeria &s) { seria_kv("status", v.status, s); }
void ser_members(cryptonote::api::cryptonoted::SubmitBlock::Request &v, ISeria &s) {
	seria_kv("blocktemplate_blob", v.blocktemplate_blob, s);
}
void ser_members(cryptonote::api::cryptonoted::BlockHeaderLegacy &v, ISeria &s) {
	ser_members(static_cast<cryptonote::api::BlockHeader &>(v), s);
	seria_kv("depth", v.depth, s);
	seria_kv("orphan_status", v.orphan_status, s);
}
void ser_members(cryptonote::api::cryptonoted::GetLastBlockHeaderLegacy::Response &v, ISeria &s) {
	seria_kv("status", v.status, s);
	seria_kv("block_header", v.block_header, s);
}
void ser_members(cryptonote::api::cryptonoted::GetBlockHeaderByHashLegacy::Request &v, ISeria &s) {
	seria_kv("hash", v.hash, s);
}
void ser_members(cryptonote::api::cryptonoted::GetBlockHeaderByHeightLegacy::Request &v, ISeria &s) {
	seria_kv("height", v.height, s);
}
