...
bool Node::on_getblocktemplate(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::cryptonoted::GetBlockTemplate::Request &&req, api::cryptonoted::GetBlockTemplate::Response &res) {
	api::cryptonoted::GetStatus::Request sta;
...
void Node::getblocktemplate(const api::cryptonoted::GetBlockTemplate::Request &req,
    api::cryptonoted::GetBlockTemplate::Response &res) {
...
bool Node::on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::cryptonoted::GetCurrencyId::Request && /*req*/, api::cryptonoted::GetCurrencyId::Response &res) {
	res.currency_id_blob = m_block_chain.get_genesis_bid();
	return true;
}

bool Node::on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::cryptonoted::SubmitBlock::Request &&req, api::cryptonoted::SubmitBlock::Response &res) {
...
bool Node::on_submitblock_legacy(http::Client *who, http::RequestData &&rd, json_rpc::Request &&jr,
    api::cryptonoted::SubmitBlockLegacy::Request &&req, api::cryptonoted::SubmitBlockLegacy::Response &res) {
	if (req.size() != 1) {
		throw json_rpc::Error{CORE_RPC_ERROR_CODE_WRONG_PARAM, "Wrong param"};
	}

	api::cryptonoted::SubmitBlock::Request other_req;
...
bool Node::on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::cryptonoted::GetLastBlockHeaderLegacy::Request &&,
    api::cryptonoted::GetLastBlockHeaderLegacy::Response &response) {
...
bool Node::on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::cryptonoted::GetBlockHeaderByHashLegacy::Request &&request,
    api::cryptonoted::GetBlockHeaderByHashLegacy::Response &response) {
...
bool Node::on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::cryptonoted::GetBlockHeaderByHeightLegacy::Request &&request,
    api::cryptonoted::GetBlockHeaderByHeightLegacy::Response &response) {
	Hash block_hash;
