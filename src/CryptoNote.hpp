...
#define cryptonote_ALLOW_DEBUG_COMMANDS 1
...
void ser(cryptonote::Hash &v, ISeria &s);
void ser(cryptonote::KeyImage &v, ISeria &s);
void ser(cryptonote::PublicKey &v, ISeria &s);
void ser(cryptonote::SecretKey &v, ISeria &s);
